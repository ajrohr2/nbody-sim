...
for m in 1:1:5
    bodies = [BasicNBodySim.Planet(5.9722e24, [0.0, 0.0], [0.0, 0.0]), :blue]
    ...
    SUITE["simulate"][n] = @benchmarkable(BasicNBodySim.simulate_without_save(bs, 31536000.0, 365*24*6, 365),evals=1,samples=100,setup=(bs = $bodies))
end
